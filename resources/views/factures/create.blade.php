...
<div class="p-4 sm:p-6">
    ...
    <form action="{{ route('factures.store') }}" method="POST" id="factureForm" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="date" name="date_facture" value="{{ old('date_facture', date('Y-m-d')) }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 pl-10 focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50" required>
        ...
        <div class="flex justify-end gap-4 pt-4 border-t border-gray-100">
            <a href="{{ route('factures.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Annuler
            </a>
