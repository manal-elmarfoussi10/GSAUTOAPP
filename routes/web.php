...
use App\Http\Requests\SuperAdmin\StoreGlobalUserRequest;
...
Route::post('clients/{client}/conversations', [ConversationController::class, 'store'])
    ...
    Route::get('/clients/{client}/', [ConversationController::class, 'show'])->name('clients.conversation');
Route::resource('clients', ClientController::class);
...
Route::get('/avoirs/{avoir}/pdf', [AvoirController::class, 'exportPDF'])->name('avoirs.pdf'); // ou export_PDF si c’est bien le nom
...
Route::prefix('superadmin')
    ->middleware(['auth', \App\Http\Middleware\SuperAdminAccess::class])
    ->name('superadmin.')
    ->group(function () {
        ...
        Route::get('companies/{company}/users/create',  [\App\Http\Controllers\SuperAdmin\UserController::class, 'create'])
             ->name('companies.users.create');
        Route::post('companies/{company}/users',        [\App\Http\Controllers\SuperAdmin\UserController::class, 'store'])
             ->name('companies.users.store');

             Route::get('companies/{company}/users/{user}/edit',
             [\App\Http\Controllers\SuperAdmin\UserController::class, 'edit'])
             ->name('companies.users.edit');
         
         Route::put('companies/{company}/users/{user}',
             [\App\Http\Controllers\SuperAdmin\UserController::class, 'update'])
             ->name('companies.users.update');
             Route::delete('companies/{company}/users/{user}', 
    [\App\Http\Controllers\SuperAdmin\UserController::class, 'destroy'])
